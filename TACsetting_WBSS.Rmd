...
<span style="color:red"> VT: I assume the $0.057TAC_{A_{WBSS+NSAS}}$ may correspond to the part of the C-fleet catch that is NSAS herring. The $0.41TAC_{WBSS}$ could correspond to the part of the C-fleet catch that is WBSS herring. Do you agree? </span>
